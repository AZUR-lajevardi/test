"""
Example 3.
You must input n, m, k.
The computer randomly selects the size of objects.
"""
import random
...
size_of_object = []
for i in range(n):
    size_of_object.append(random.randint(1, k))

print("The size of objects selected by computer: ", size_of_object)
